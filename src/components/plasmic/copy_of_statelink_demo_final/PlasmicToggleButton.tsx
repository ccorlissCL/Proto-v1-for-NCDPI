...
import sty from "./PlasmicToggleButton.module.css"; // plasmic-import: 1PJNAzmgdwtH/css
    ...
    <div
      ...
      onClick={async event => {
                ...
                vgroup: __wrapUserFunction(
                  {
                    ...
                    interactionUuid: "gxqLfL66orfP",
                    componentUuid: "1PJNAzmgdwtH",
                    argName: "vgroup"
                  },
                  () => "position2"
                ),
        ...
        if (
          ...
          $steps["updatePosition2"] = await __wrapUserPromise(
            {
              type: "InteractionLoc",
              actionName: "updateVariant",
              interactionUuid: "gxqLfL66orfP",
    ...
    >
      ...
      <div
        className={classNames(
          ...
          sty.text__bbnln,
          {
            [sty.textposition2__bbnlnz697R]: hasVariant(
              $state,
              "position2",
              "position2"
            )
      ...
      <div
        className={classNames(
          ...
          sty.text__czUWv,
          {
            [sty.textposition2__czUWvz697R]: hasVariant(
              $state,
              "position2",
              "position2"
            )
